...
class EvaluatorGEval:
    ...
    def __init__(self, groundx_api_key: str, openrouter_api_key: str, comet_api_key: Optional[str] = None):
    ...
    def _gpt_direct(self, q: str, raw: bytes, mime: str) -> str:
        ...
        response = requests.post(
            ...
            json={
                "model": "openai/gpt-4o",
                "messages": [
                    {"role": "system", "content": "You are an expert document analyser."},
...
def create_evaluator_geval() -> EvaluatorGEval:
    ...
    if not gx_key or not openrouter_key:
        raise ValueError("API keys missing: GROUNDX_API_KEY and OPENROUTER_API_KEY are required")
    return EvaluatorGEval(gx_key, openrouter_key, comet_key)
